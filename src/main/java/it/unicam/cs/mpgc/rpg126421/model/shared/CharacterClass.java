...
public enum CharacterClass {
    ...
    SMUGGLER       ("Smuggler",      5, 6, 4, "Canali oscuri: accesso a sconti e scorciatoie"),
    ...
    CharacterClass(String displayName, int strength, int tech, int resilience, String perk) {
