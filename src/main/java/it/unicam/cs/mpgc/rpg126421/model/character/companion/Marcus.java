...
public class Marcus extends PermanentCompanion {
    ...
    public String reactToChoice(String choiceFlag) {
        return switch (choiceFlag) {
            ...
            case "ep3_deal_accepted_true"     -> "\"...non dire nulla. Non voglio sentirlo.\"";
            case "ep3_kessler_delivered_true" -> "\"Forse questa volta facciamo la cosa giusta.\"";
            case "ep3_servers_destroyed_true" -> "\"Niente prove, niente processo. Ma almeno è finita.\"";
            case "ep3_broadcast_true"         -> "\"Aaron avrebbe voluto vederlo. Tutto quanto.\"";
            default                           -> "";
        };
    }
}